    ...
    return (
        <Template>
            <section className='flex flex-col items-center justify-center my-5'>
                <h5 className='mt-3 mb-10 text-3xl font-extrabold tracking-tigh text-gray-900'>Nova Imagem</h5>
                <form action="">
                    ...
                    <div className='mt-5 grid grid-cols-1'>
                        ...
                        <div className='mt-2 flex justify-center rounded-lg borer border-dashed border-gray-900/25 px-6 py-10'>
                            <div className='text-center'>
                                ...
                                <div className='mt-4 flex text-sm leading-6 text-gray-600'>
                                    <label className='relative cursor-pointr rounded-md bg-white font-semibold text-indigo-600'>
